...
<head>
    ...
    @livewireStyles
    <style>
        #section-research-groups, #section-projects, #section-publications,
        [onclick*="add-group-tab"], [onclick*="add-project-tab"], [onclick*="add-publication-tab"],
        [onclick*="showSection('research-groups'"], [onclick*="showSection('projects'"], [onclick*="showSection('publications'"] {
...
<nav class="sidebar">
    ...
    <div class="sidebar-section">
        ...
        <button class="nav-item" onclick="window.location.href='http://127.0.0.1:8001/#research-groups'">
            <span class="icon">🔬</span> {{ $t('Research Groups', 'المجموعات البحثية') }}
            <span class="nav-badge">{{ $totalResearchGroups }}</span>
        </button>
        <button class="nav-item" onclick="window.location.href='http://127.0.0.1:8001/#projects'">
            <span class="icon">📁</span> {{ $t('Projects', 'المشاريع البحثية') }}
            <span class="nav-badge">{{ $totalProjects }}</span>
        </button>
        <button class="nav-item" onclick="window.location.href='http://127.0.0.1:8001/#publications'">
